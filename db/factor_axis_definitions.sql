...
-- taxonomy_based has been removed from the axes because taxonomy/tag relationships
-- are now handled separately through empirical tag-factor relationship analysis.

delete from factor_axis_definitions
where key = 'taxonomy_based';

insert into factor_axis_definitions
