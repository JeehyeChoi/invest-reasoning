...
export const SEC_METRIC_DEFINITIONS = {
  ...
  interest_income: { kind: "internal", durationPolicy: "duration_adjust_growth" },
  ...
  share_repurchases: { kind: "canonical", durationPolicy: "reported_only" },
  ...
  accounts_receivable: { kind: "canonical", durationPolicy: "not_applicable" },
  inventory: { kind: "canonical", durationPolicy: "not_applicable" },
  accounts_payable: { kind: "canonical", durationPolicy: "not_applicable" },
  cash_and_cash_equivalents: { kind: "internal", durationPolicy: "not_applicable" },
  cash_and_short_term_investments: { kind: "internal", durationPolicy: "not_applicable" },
  assets: { kind: "internal", durationPolicy: "not_applicable" },
  liabilities: { kind: "canonical", durationPolicy: "not_applicable" },
  short_term_debt: { kind: "internal", durationPolicy: "not_applicable" },
  long_term_debt: { kind: "internal", durationPolicy: "not_applicable" },
  total_debt: { kind: "internal", durationPolicy: "not_applicable" },
